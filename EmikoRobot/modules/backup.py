...
# from Emiko.modules.sql import warns_sql as warnssql
import EmikoRobot.modules.sql.blacklist_sql as blacklistsql

# from Emiko.modules.sql import cust_filters_sql as filtersql
# import Emiko.modules.sql.welcome_sql as welcsql
...
def export_data(update, context):
    ...
    with open("Siesta-Robot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Siesta-Robot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Siesta-Robot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Siesta-Robot{}.backup".format(chat_id))  # Cleaning file
