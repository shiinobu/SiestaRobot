...
buttons = [
    [
              InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        "✚ Add me to your Group", url=f"https://t.me/hypermen_rbot?startgroup=true"),
                ],
                [
                    InlineKeyboardButton(
                        "👤 Owner", url=f"t.me/Official_Afk_xD"
                    ),
                    InlineKeyboardButton(
                        "🛡️ About", callback_data="siesta_"                  
                    ),
                    InlineKeyboardButton(
                        "🤖 Bot", callback_data="settings_helper"                         
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "🎵 VC Help ", callback_data="settings_back_helper"),
    ],
]
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @Official_Afk_xD \
...
def siesta_about_callback(update, context):
    ...
    if query.data == "siesta_":
        query.message.edit_text(
            text="๏ I'm *Hyper*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Hyper licensed under the GNU General Public License v3.0_"
            "\n\n‣ Click on button bellow to get basic help for Hypermen Robot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="Notes 🖍️", callback_data="siesta_notes"),
                 ],
                 [
        ...
        query.message.edit_text(
            text="*๏ Hyper support chats*"
            "\n‣ Join My Support Group/Channel for see or report a problem on Hyper.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
        ...
        query.message.edit_text(
            text=f"๏ Credis for Hyper\n"
            "\n‣ Here Developers Making And Give Inspiration For Made The Siesta Robot",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Log Afk xD", url="https://t.me/Log_Afk"),
                    InlineKeyboardButton(text="Official Afk", url="https://t.me/Official_afk_xD"),
                 ],
                 [
                    InlineKeyboardButton(text="Evil Boy", url="https://t.me/Evil_xD_Boy"),
                    InlineKeyboardButton(text="Team Blaze", url="t.me/Team_Blaze_xD"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="siesta_"),
                 ]
