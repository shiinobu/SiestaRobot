...
import NaoRobot.modules.sql.connection_sql as sql
from NaoRobot import dispatcher, DRAGONS, DEV_USERS
from NaoRobot.modules.helper_funcs import chat_status
